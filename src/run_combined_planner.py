...
# create road boundary and scenario collision checker
...
while not goal.is_reached(x_0):
    ...
    draw_object(ego_vehicle, draw_params={'time_begin': current_count, "dynamic_obstacle": {"facecolor": "green", "zorder": 30}})
    ...
    plt.autoscale()
    plt.savefig(f"{plot_path}/{scenario.benchmark_id}_{current_count + 1}.png", format='png', dpi=300, bbox_inches='tight')
    plt.close()
